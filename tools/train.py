...
def parse_args():
    ...
    parser.add_argument('--gpus',type=int,default=2,help='number of gpus to use ''(only applicable to non-distributed training)')
...
def main():
    ...
    cfg.load_from = work_dir_base+'/work_dirs/Diffusion_16x_v2/iter_31000.pth'
    cfg.gpus = args.gpus
