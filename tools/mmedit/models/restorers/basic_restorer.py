...
from mmedit.core import psnr, ssim, tensor2img, reorder_image
...
def cal_lpips(img1, img2, crop_border=0, input_order='HWC', convert_to=None):
...
class BasicRestorer(BaseModel):
    ...
    """
    allowed_metrics = {'PSNR': psnr, 'SSIM': ssim, 'LPIPS': cal_lpips}
